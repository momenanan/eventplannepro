...
logInfo(String.format("  vN: %d", vNumber));
logInfo(String.format("    d: %s  and in cal : %s", d, sDateCalender));
logInfo(String.format("     start_at: %d", startAt));
logInfo(String.format("       end_at: %d", endAt));
